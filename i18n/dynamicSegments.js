...
// src/i18n/dynamicSegments.js

export const dynamicSegments = {
  type: {
  
    rooms: { en: 'rooms', sr: 'sobe' },
    studios: { en: 'studios', sr: 'studiji' },
    apartments: { en: 'apartments', sr: 'apartmani' },
  },
  slug: {
 
'three-bed-studio-on-first-floor-with-balcony':{en:"vanilla-sky", sr:'vanilla-sky'},
      
      'triple-room-with-private-external-bathroom' :{en:'vanilla-dreams', sr: 'vanilla-dreams'},
      'triple-room-with-private-bathroom-and-kitchen-outside-the-room' :{en:'sienna', sr:'sienna'},
      'double-studio' :{en:'studio-classic', sr:'studio-classic'},
      'sea-view-apartment-for-five-on-top-floor' :{en:'golden', sr:'golden'},
      '3-person-apartment-on-3rd-floor' :{en:'sunrise-I', sr:'sunrise-I' },
      '4-person-apartment-on-3rd-floor' :{en:'primavera', sr:'primavera'} ,
