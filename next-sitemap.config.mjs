...
const apartmentsEn = JSON.parse(
  fs.readFileSync(path.join(process.cwd(), 'data', 'locales', 'en', 'apartments-description.json'), 'utf8')
);

const apartmentsSr = JSON.parse(
  fs.readFileSync(path.join(process.cwd(), 'data', 'locales', 'sr', 'apartments-description.json'), 'utf8')
);
